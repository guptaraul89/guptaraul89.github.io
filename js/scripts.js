$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Rahul and Akancha's Wedding",

            // Event start date
            start: new Date('Feb 14, 2020 10:00'),
            ...
            end: new Date('Feb 15, 2020 00:00'),

            // Event Address
            address: 'Gen AK Vaidya Marg, Camp, Pune, Maharashtra 411001, India',
...
// Google map
function initMap() {
    var itc_kol = {lat: 18.529026, lng: 73.880224};
...
function initBBSRMap() {
    var la_fiesta = {lat: 18.529026, lng: 73.880224};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
